 ...
 */
public abstract class Hilt_CartItemsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CartItemsFragment() {
    super();
  }

  Hilt_CartItemsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CartItemsFragment_GeneratedInjector) this.generatedComponent()).injectCartItemsFragment(UnsafeCasts.<CartItemsFragment>unsafeCast(this));
    }
  }
