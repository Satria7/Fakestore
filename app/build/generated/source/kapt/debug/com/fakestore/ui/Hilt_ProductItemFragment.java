 ...
 */
public abstract class Hilt_ProductItemFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductItemFragment() {
    super();
  }

  Hilt_ProductItemFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductItemFragment_GeneratedInjector) this.generatedComponent()).injectProductItemFragment(UnsafeCasts.<ProductItemFragment>unsafeCast(this));
    }
  }
