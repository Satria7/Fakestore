 ...
 */
public abstract class Hilt_SignupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignupFragment_GeneratedInjector) this.generatedComponent()).injectSignupFragment(UnsafeCasts.<SignupFragment>unsafeCast(this));
    }
  }
