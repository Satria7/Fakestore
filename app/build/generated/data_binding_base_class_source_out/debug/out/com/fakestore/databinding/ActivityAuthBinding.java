...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FragmentContainerView authNavHostFragment = ViewBindings.findChildViewById(rootView, id);
      if (authNavHostFragment == null) {
        break missingId;
      }

      return new ActivityAuthBinding((ConstraintLayout) rootView, authNavHostFragment);
    }
